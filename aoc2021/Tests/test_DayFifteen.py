...
from aoc2021.Code import DayFifteen
...
def test_GetPart2Data():
    ...
    result = DayFifteen.GetPart2Data(testData)
    assert result == expected


def test_PartOne():
    providedAnswer = 40
    assert DayFifteen.PartOne(testData) == providedAnswer


def test_PartTwo():
    providedAnswer = 315
    assert DayFifteen.PartTwo(testData) == providedAnswer
