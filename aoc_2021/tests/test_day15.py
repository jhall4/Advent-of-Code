from aoc_2021.code import DayFifteen
import sys
import pathlib
...
def test_GetPart2data():
    expected = complexdata
    result = DayFifteen.GetPart2data(test_data)
    assert result == expected


def test_part_one():
    provided_answer = 40
    assert DayFifteen.part_one(test_data) == provided_answer


def test_part_two():
    provided_answer = 315
    assert DayFifteen.part_two(test_data) == provided_answer
